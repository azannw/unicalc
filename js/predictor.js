...
function renderResultCard() {
    ...
    card.innerHTML = `
        ...
        <div class="result-card-footer">Calculate yours at <strong>unicalc.csconnect.pk</strong></div>`;
}
...
function shareWhatsApp() {
    ...
    text += `\nCalculate yours: https://unicalc.csconnect.pk/predictor/`;
...
async function downloadPDF() {
    ...
    pdf.text('Generated by UniCalc — unicalc.csconnect.pk', 105, 287, { align: 'center' });
