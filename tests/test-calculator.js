...
const calculatorConfigs = {
    ...
    giki:        { weights: { matric: 0, inter: 0.15, test: 0.85 }, testMax: 200 },
    pieas:       { weights: { matric: 0.15, inter: 0.25, test: 0.60 }, testMax: 100 },
    uet:         { weights: { matric: 0.17, inter: 0.50, test: 0.33 }, testMax: 400 },
    ned:         { weights: { matric: 0, inter: 0.50, test: 0.50 }, testMax: 100 },
    ist:         { weights: { matric: 0.20, inter: 0.40, test: 0.40 }, testMax: 100 },
    nutech:      { weights: { matric: 0.10, inter: 0.20, test: 0.70 }, testMax: 200 },
    pucit:       { weights: { matric: 0.25, inter: 0.35, test: 0.40 }, testMax: 100 },
    air:         { weights: { matric: 0.10, inter: 0.50, test: 0.40 }, testMax: 100 },
    bahria:      { weights: { matric: 0.10, inter: 0.30, test: 0.60 }, testMax: 100 },
    pu:          { weights: { matric: 0.25, inter: 0.35, test: 0.40 }, testMax: 100 },
    uhs:         { weights: { matric: 0.10, inter: 0.40, test: 0.50 }, testMax: 200 },
    nums:        { weights: { matric: 0.10, inter: 0.40, test: 0.50 }, testMax: 200 },
};
...
const testCases = [
    ...
    { id: 'giki', matric: 950, mTotal: 1100, inter: 980, iTotal: 1100, test: 170, tTotal: 200,
      expected: (950/1100*100)*0 + (980/1100*100)*0.15 + (170/200*100)*0.85 },
    { id: 'ist', matric: 950, mTotal: 1100, inter: 980, iTotal: 1100, test: 75, tTotal: 100,
      expected: (950/1100*100)*0.20 + (980/1100*100)*0.40 + (75/100*100)*0.40 },
    { id: 'ned', matric: 950, mTotal: 1100, inter: 980, iTotal: 1100, test: 70, tTotal: 100,
      expected: (950/1100*100)*0 + (980/1100*100)*0.50 + (70/100*100)*0.50 },
    ...
    { id: 'pucit', matric: 950, mTotal: 1100, inter: 980, iTotal: 1100, test: 75, tTotal: 100,
      expected: (950/1100*100)*0.25 + (980/1100*100)*0.35 + (75/100*100)*0.40 },
    { id: 'air', matric: 950, mTotal: 1100, inter: 980, iTotal: 1100, test: 75, tTotal: 100,
      expected: (950/1100*100)*0.10 + (980/1100*100)*0.50 + (75/100*100)*0.40 },
    { id: 'bahria', matric: 950, mTotal: 1100, inter: 980, iTotal: 1100, test: 70, tTotal: 100,
      expected: (950/1100*100)*0.10 + (980/1100*100)*0.30 + (70/100*100)*0.60 },
    ...
    { id: 'nums', matric: 1070, mTotal: 1100, inter: 1050, iTotal: 1100, test: 170, tTotal: 200,
      expected: (1070/1100*100)*0.10 + (1050/1100*100)*0.40 + (170/200*100)*0.50 },
];
